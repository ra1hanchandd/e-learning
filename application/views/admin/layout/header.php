...
<head>
    ...
    <title><?= $title ?> - E-Learning Bootcamp Admin</title>
    <!-- Google Fonts -->
...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li>
                <a href="<?= site_url('admin/dashboard') ?>" class="<?= uri_string() == 'admin/dashboard' || uri_string() == 'admin' ? 'active' : '' ?>">
            ...
            <li>
                <a href="<?= site_url('admin/mentor') ?>" class="<?= strpos(uri_string(), 'admin/mentor') !== false ? 'active' : '' ?>">
                    <i class="bi bi-person-workspace"></i> Mentor
                </a>
            </li>
            <li>
                <a href="<?= site_url('admin/bootcamp') ?>" class="<?= strpos(uri_string(), 'admin/bootcamp') !== false ? 'active' : '' ?>">
                    <i class="bi bi-mortarboard-fill"></i> Bootcamp
                </a>
            </li>
            <li>
                <a href="<?= site_url('admin/batch') ?>" class="<?= strpos(uri_string(), 'admin/batch') !== false ? 'active' : '' ?>">
                    <i class="bi bi-calendar3"></i> Batch
                </a>
            </li>
            <li>
                <a href="<?= site_url('admin/peserta') ?>" class="<?= strpos(uri_string(), 'admin/peserta') !== false ? 'active' : '' ?>">
            ...
            <li>
                <a href="<?= site_url('admin/pendaftaran') ?>" class="<?= strpos(uri_string(), 'admin/pendaftaran') !== false ? 'active' : '' ?>">
                    <i class="bi bi-clipboard2-check"></i> Pendaftaran
                </a>
            </li>
            <li>
                <a href="<?= site_url('admin/absensi') ?>" class="<?= strpos(uri_string(), 'admin/absensi') !== false ? 'active' : '' ?>">
                    <i class="bi bi-calendar-check-fill"></i> Absensi
                </a>
            </li>
            <li>
                <a href="<?= site_url('admin/tugas') ?>" class="<?= strpos(uri_string(), 'admin/tugas') !== false ? 'active' : '' ?>">
                    <i class="bi bi-journal-text"></i> Tugas
                </a>
            </li>
            <li>
                <a href="<?= site_url('admin/penilaian') ?>" class="<?= strpos(uri_string(), 'admin/penilaian') !== false ? 'active' : '' ?>">
            ...
            <li>
                <a href="<?= site_url('admin/report') ?>" class="<?= strpos(uri_string(), 'admin/report') !== false ? 'active' : '' ?>">
