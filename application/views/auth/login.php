...
<head>
    ...
    <title>Login - E-Learning Bootcamp</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-features .feature-text h5 { margin: 0 0 4px; font-weight: 600; }
        .auth-features .feature-text p { margin: 0; opacity: 0.8; font-size: 0.9rem; }
        ...
        .auth-form-wrapper .subtitle { color: #64748b; margin-bottom: 40px; }
    ...
    <div class="auth-wrapper">
        <div class="auth-left">
            <div class="auth-brand">
                ...
                <h1>EduCamp</h1>
                <p>Platform e-learning terbaik untuk mengembangkan skill teknologi Anda bersama mentor berpengalaman.</p>
                ...
                <div class="auth-features">
                    <div class="feature">
                        ...
                        <div class="feature-text">
                            ...
                            <p>Akses materi kapan saja, dimana saja</p>
                        </div>
                    </div>
                    <div class="feature">
                        ...
                        <div class="feature-text">
                            <h5>Mentor Expert</h5>
                            <p>Dibimbing oleh praktisi industri</p>
                        </div>
                    </div>
                    <div class="feature">
